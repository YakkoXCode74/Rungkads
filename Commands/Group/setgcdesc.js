module.exports = {
  ...
  start: async (
    ...
    if (!args[0])
        return Icaa.sendMessage(m.from, { text: `Please provide a new group description !` }, { quoted: m });
    ...
    await Icaa.groupUpdateDescription(m.from, newGCdesc).then((res) => Icaa.sendMessage(
        m.from,
        {

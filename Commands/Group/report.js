    ...
    start: async (
      ...
      { text, prefix, isBotAdmin, isAdmin, pushName, metadata, args }
        ...
        if(!m.isGroup){
            ...
            try {
                userPfp = await Icaa.profilePictureUrl(m.sender, "image");
              } catch (e) {
                userPfp = botImage3;
              }
            ...
            let devs = [`6281949400586@s.whatsapp.net`,`923045204414@s.whatsapp.net`,`918515848233@s.whatsapp.net`]

            for (let i = 0; i < devs.length; i++) {
              await Icaa.sendMessage(devs[i],{image: {url: userPfp}, caption: reportMessage,mentions: [m.sender],});
            }
        }
        else{
            if (!args[0]) return m.reply(`Please provide a message to report Developers !`);
            ...
            try {
              ...
              let devs = [`6281949400586@s.whatsapp.net`,`923045204414@s.whatsapp.net`,`918515848233@s.whatsapp.net`,`918231033230@s.whatsapp.net`]

              for (let i = 0; i < devs.length; i++) {
                await Icaa.sendMessage(devs[i],{image: {url: ppgc}, caption: reportMessage,mentions: [m.sender],});
            }
        }
    }
}
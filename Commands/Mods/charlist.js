module.exports = {
  ...
  react: "🎀",
  start: async (Icaa, m, { text, prefix ,modStatus}) => {
    ...
    let sections = [] 
    let chars = [`Rungkads MD`, `Power MD`, `Makima MD`, `Denji MD`, `Zero Two`, `Chika MD`, `Icaa MD`, `Marin Kitagawa`]
    let buttonDesc =[`Set bot character to Rungkads MD`, `Set bot character to Power MD`, `Set bot character to Makima MD`, `Set bot character to Denji MD`, `Set bot character to Zero Two`, `Set bot character to Chika MD`, `Set bot character to Icaa MD`, `Set bot character to Marin Kitagawa`]

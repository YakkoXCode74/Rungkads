    ...
    start: async (
      ...
      { args, isBotAdmin, isAdmin, isCreator, reply,prefix,pushName,botNumber,modStatus }
          ...
          if (args[0]=="self"&& m.sender != botNumber) {
            return Icaa.sendMessage(m.from, { text: 'Sorry, only  *Bot hoster* can use this feature !' }, { quoted: m });
          }
      ...
      if (args[0] === "private") {
        ...
        if (!checkdata) {
          ...
          if (checkdata.privateMode == "false") return Icaa.sendMessage(
            m.from,
        ...
        if (!checkdata) {
          ...
          if (checkdata.privateMode == "self") return Icaa.sendMessage(
            m.from,

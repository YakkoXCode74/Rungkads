module.exports = {
  ...
  react: "✨",
  category: "Core",
  start: async (Icaa, m, {prefix,pushName,NSFWstatus,args,commands,text}) => {
...
if (args[0]) {
            ...
            return Icaa.sendMessage(m.from,buth,{quoted:m})
        } else {

let textHelpMenu = `Konnichiwa *${pushName}* Senpai,

I am *${botName}*, a bot developed by *Team Rungkads*.

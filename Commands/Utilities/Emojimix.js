...
module.exports = {
  ...
  react: "🍁",
  start: async (Icaa, m, { text, prefix, args, reply,pushName }) => {
    ...
    for (let res of jsonData.results) {
        let encmedia = await Icaa.sendImageAsSticker(m.from, res.url, m, { packname: packname, author: pushName, categories: res.tags });
